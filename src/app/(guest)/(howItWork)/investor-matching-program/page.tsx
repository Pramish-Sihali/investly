  ...
  const programStages = [
    {
      ...
      description:
        "Our team conducts a comprehensive evaluation of your startup's potential, market fit, and investment readiness.",
      icon: BarChart3,
    },
    {
      title: 'Investor Profiling',
      description:
        "We create a detailed investor profile matching your startup's unique needs with the right investor network.",
      icon: Rocket,
    },
    {
      title: 'Coaching & Preparation',
      description:
        'Receive personalized coaching to refine your pitch, financial models, and investor presentation.',
      icon: Briefcase,
    },
    {
      title: 'Investor Introductions',
      description:
        "Direct introductions to carefully selected investors who align with your startup's vision and growth potential.",
      icon: BarChart3,
    },
  ];
  ...
  const benefitsOfProgram = [
    {
      ...
      description:
        'Precision-matched with investors who have expertise in your industry and investment thesis.',
      icon: '/startup.png',
    },
    {
      title: 'Comprehensive Support',
      description:
        '30-90 days of dedicated support to prepare and position your startup for successful fundraising.',
      icon: '/startup1.png',
    },
    {
      title: 'Network Expansion',
      description:
        'Access to an exclusive network of angel investors, venture capitalists, and strategic partners.',
      icon: '/startup2.png',
    },
  ];
...
"
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
            {benefitsOfProgram.map((benefit) => (
              ...
              >
                <div className="flex justify-center mb-6">
                  <Image src={benefit.icon} alt={benefit.title} width={64} height={64} />
                </div>
      ...
      <section className="text-center mt-16">
        ...
        <p className="text-xl text-gray-600 mb-8">
          Join our Investor Matching Program and take the first step towards securing the right
      ...
      <section className="mt-16 bg-blue-50 p-12 rounded-lg">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700">
            We don&apos;t just match startups with investors. We provide a holistic support system
            that prepares your startup for successful fundraising, helping you build compelling
            narratives and robust investment strategies.
          </p>
        </div>
      </section>
    </div>
