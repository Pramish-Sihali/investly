...
import SocialShareSidebar from '@/components/ui/social-icon-sidebar';
...
export default async function BlogDetailPage({ params }: BlogDetailPageProps) {
  ...
  const shareData = {
    title: blog.title,
    description: `Check out this amazing article: ${blog.title}`,
    image: `${process.env.NEXT_PUBLIC_API_URL}${blog.thumbnailImage}`,
    url: `/blog/${blog.slug}`,
  };
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-3">
              <SocialShareSidebar shareData={shareData} />
            </div>
          </div>
        </div>
      </div>
