      ...
      <div className="p-4 mb-16">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            Investment Network (BAIN) aims to promote a dynamic investment ecosystem by connecting
            angel investors with promising startups and businesses. It facilitates investor-investee
            matchmaking, providing early-stage enterprises access to funding through angel
            investment and mentorship through its established angel networks.
          </p>
        </div>
      </div>
